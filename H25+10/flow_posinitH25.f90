...
!Dados que precisam satisfazer condições especiais
 ...
 Ly = (25.d0 + 2.d0 + 10.d0)*Lcell                    !Tamanho da parede em y (m)
!*********************************************************************************
...
!Número de rugosidades
 ...
 !Número de bolas
 !Tirei um a mais pra poder dar DEZ KRLLLLL células antes de bater na parede
 Nballs = (nxis)*(nyip-nyiprough-10)
...
open(unit=51,file='initflowH25.dat',status='unknown')
