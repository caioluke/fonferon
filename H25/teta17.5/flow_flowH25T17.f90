...
open(unit=30,file='initflowH25.dat',status='old')
open(unit=31,file='ktotalH25T17.dat',status='unknown')
...
!- Ajustar o ângulo antes de simular
 ...
 flow_angle1 = (17.5d0)*0.01745329252d0
