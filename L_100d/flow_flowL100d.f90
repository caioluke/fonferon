...
open(unit=30,file='initflowL100d.dat',status='old')
open(unit=31,file='vestabflowL100d.dat',status='unknown')
open(unit=32,file='vper1flowL100d.dat',status='unknown')
open(unit=33,file='vper2flowL100d.dat',status='unknown')
...
!- Ângulo de escoamento está no outro programa também
