...
open(unit=30,file='initflowL40d.dat',status='old')
open(unit=31,file='vestabflowL40d.dat',status='unknown')
open(unit=32,file='vper1flowL40d.dat',status='unknown')
open(unit=33,file='vper2flowL40d.dat',status='unknown')
