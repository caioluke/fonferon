...
open(unit=30,file='initflowL80d.dat',status='old')
open(unit=31,file='vestabflowL80d.dat',status='unknown')
open(unit=32,file='vper1flowL80d.dat',status='unknown')
open(unit=33,file='vper2flowL80d.dat',status='unknown')
