...
!open(unit=69,file='backup.dat',status='old')
 ...
 read(30,*) h,densidade,g,gamaS,minormal,miparede,Hmax
 read(30,*) scale,xinfesq,yinfesq,xsupdir,ysupdir
 read(30,*) mmax,K1,K2,K3,gamaN1,gamaN2,gamaN3
 !read(69,*) n+1,flow_angle1 
...
!Para gerar o arquivo da condiçao inicial
 ...
 call salva_eps(cont,Lx,Ly,Nballs,R,S(:,1),S(:,2),ang,Nroughs,rrough,Srough,scale,xinfesq,yinfesq,xsupdir,ysupdir,v)
...
do n=ninit,100*10000
	...
	if(n.le.100) then
		flow_angle = (24.d0)*0.01745329252d0
	else 
	...
	if(mod(n,15*10000).eq.0) then
		...
		write(69,*) h,densidade,g,gamaN1,gamaN2,gamaS,minormal,miparede,Hmax
		write(69,*) scale,xinfesq,yinfesq,xsupdir,ysupdir
		write(69,*) mmax,K1,K2,K3,gamaN1,gamaN2,gamaN3
		write(69,*) n+1,flow_angle1 
		do j=1,Nballs
...
& ,scale,xinfesq,yinfesq,xsupdir,ysupdir,v)
 implicit none
